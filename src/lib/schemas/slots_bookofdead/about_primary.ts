...
export const slots_bookofdead_about_primary_schema = z.object({
    blocks: z.array(
...
export type SlotsBookOfDeadAboutPrimary = z.infer<typeof slots_bookofdead_about_primary_schema>;