...
export const sportsbook_basketball_about_primary_schema = z.object({
    blocks: z.array(
...
export type SportsbookBasketballAboutPrimary = z.infer<typeof sportsbook_basketball_about_primary_schema>;