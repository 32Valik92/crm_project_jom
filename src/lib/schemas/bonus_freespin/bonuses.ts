// src/lib/schemas/bonus_freespin/bonuses.ts
import { z } from "zod";
...
export const bonus_freespin_bonuses_schema = z.object({
    title: z.string().min(1, "Обов'язково"),
...
export type BonusFreespinBonuses = z.infer<typeof bonus_freespin_bonuses_schema>;
