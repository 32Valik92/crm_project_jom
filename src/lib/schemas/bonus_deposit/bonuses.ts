// src/lib/schemas/bonus_deposit/bonuses.ts
import { z } from "zod";
...
export const bonus_deposit_bonuses_schema = z.object({
    title: z.string().min(1, "Обов'язково"),
...
export type BonusDepositBonuses = z.infer<typeof bonus_deposit_bonuses_schema>;
