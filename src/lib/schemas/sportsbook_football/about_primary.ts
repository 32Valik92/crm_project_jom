...
export const sportsbook_football_about_primary_schema = z.object({
    blocks: z.array(
...
export type SportsbookFootballAboutPrimary = z.infer<typeof sportsbook_football_about_primary_schema>;