...
export const slots_bookofradeluxe_about_primary_schema = z.object({
    blocks: z.array(
...
export type SlotsBookOfRaDeluxeAboutPrimary = z.infer<typeof slots_bookofradeluxe_about_primary_schema>;