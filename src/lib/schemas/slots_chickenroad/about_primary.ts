...
export const slots_chickenroad_about_primary_schema = z.object({
    blocks: z.array(
...
export type SlotsChickenRoadAboutPrimary = z.infer<typeof slots_chickenroad_about_primary_schema>;