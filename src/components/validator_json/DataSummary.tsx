...
const CircleIcon = () => (
	<svg className="size-4 text-slate-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"
	     strokeLinecap="round" strokeLinejoin="round">
...
const DataSummary = ({data, BLOCK_META}: Props) => {
	...
	return (
		<section
			className="rounded-2xl border border-slate-700 bg-slate-800/90 backdrop-blur-sm p-6 shadow-lg shadow-slate-900/50 text-slate-50 transition-all duration-500 hover:shadow-xl hover:border-sky-500/50">
			<header className="mb-5 flex items-center justify-between">
				<h2
					className="text-xl font-bold tracking-tight bg-gradient-to-r from-sky-400 to-blue-500 bg-clip-text text-transparent">
					Поточні дані
				</h2>
